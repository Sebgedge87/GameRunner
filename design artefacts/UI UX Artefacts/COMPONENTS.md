...
|-----------|------|--------|----------|
| `OverlayCard` | components/overlay-card.md | ⬜ TODO | Inline action rows on Factions, PlotHooks, Handouts, Bestiary, Rumours |
| `OverflowMenu` | components/overflow-menu.md | ⬜ TODO | Inline Pin/Hide/Share/Edit/Delete buttons |
| `ConfirmDialog` | components/confirm-dialog.md | ⬜ TODO | No existing confirm — adds missing safety layer |
